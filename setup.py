...
def main():
    ...
    data_files   = [('etc', ['doc/FullConfiguration.py', 'doc/ExampleConfiguration.py', 'etc/crab-bash-completion.sh', 'etc/init-light.sh'])] # list of tuples whose entries are (dir, [data_files])
