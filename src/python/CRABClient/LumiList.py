...
"""
THIS IS A FROZEN IMPORT FROM CMSSW_11_1
the first CMSSSW release with support for python3
https://github.com/cms-sw/cmssw/blob/CMSSW_11_1_0/FWCore/PythonUtilities/python/LumiList.py
to be used on older CMSSW_10
