...
mapping = {
    'submit' :  { 'map': {  "jobtype"       : {"default": "Analysis",       "config": None,                     "type": "StringType",  "required": True },
                            ...
                            "maxjobruntime"     : {"default": 1315,             "config": "JobType.maxjobruntime",  "type": "IntType",     "required": False},
                            "numcores"          : {"default": 1,                "config": "JobType.numcores",       "type": "IntType",     "required": False},
                            "maxmemory"         : {"default": 2000,             "config": "JobType.maxmemory",      "type": "IntType",     "required": False},
