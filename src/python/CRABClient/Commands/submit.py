...
class submit(SubCommand):
    ...
    def __call__(self):
        ...
        self.logger.info(colors.GREEN+"Your task has been delivered to the CRAB3 server. Please use 'crab status' to check how the submission process proceeds"+colors.NORMAL)
