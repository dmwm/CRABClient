...
#html_theme_options = {}
#html_theme_path = []
html_title = 'CRAB Client, version %s ' % version
...
#html_use_opensearch = ''
#html_file_suffix = ''
htmlhelp_basename = 'CMSCRABClientdoc'

latex_paper_size = 'a4'
#latex_font_size = '10pt'
# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
  ('index', 'CMSCRABClient.tex', u'CMS CRAB Client Documentation',
